"""
LeafScan — AI Code Patch Generator
...
def generate_git_patch(finding, source_dir_path, config):
    ...
    ai = AIClient(config)
    if not ai.enabled:
        return "⚠️ AI Integration is disabled. Enable it to generate code patches: 'leafscan config set ai.enabled true'"
